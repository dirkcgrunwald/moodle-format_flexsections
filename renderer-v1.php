...
class format_flexsections_renderer extends format_section_renderer_base {
    ...
    public function print_single_section_page_no_summary($course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
        global $PAGE;
	...
	echo var_dump($section);
        ...
        if ($contentvisible && ($section->collapsed == FORMAT_FLEXSECTIONS_EXPANDED || !$level )) {
		    ...
		    if ($num -> section > 0) {
		      echo $this -> print_single_section_page_no_summary($course, NULL, NULL, NULL, NULL,
									 $num -> section);
		    }
                }
